...
- (void)getCloudVideoMonth:(NSDate*)date {
    ...
    NSDateComponents * components = [[[NSCalendar alloc] initWithCalendarIdentifier:NSCalendarIdentifierGregorian] components:NSCalendarUnitDay | NSCalendarUnitMonth | NSCalendarUnitYear fromDate:date];
...
- (void)searchCloudVideo:(NSDate*)date DeviceMac:(NSString *)deviceMac {
...
//    }
    ...
    beginNTime.hour = (int)compt.hour;
    beginNTime.minute = (int)compt.minute;
    beginNTime.second = (int)compt.second;
//    beginNTime.day = 26;
//    beginNTime.hour = 0;
//    beginNTime.minute = 0;
//    beginNTime.second = 0;
...
//    MC_SearchMediaByTime(self.MsgHandle, SZSTR(channel.deviceMac),  -1,"main",beginTime,endTime,0);
     MC_SearchMediaByTime(self.MsgHandle, SZSTR(deviceMac),  -1,"main",beginTime,endTime,0);
}

- (void)searchCloudVideo:(NSDate*)date endDate:(NSDate*)endDate DeviceMac:(NSString *)deviceMac {
    fileArray = [[NSMutableArray alloc] initWithCapacity:0];
    timeArray = [[NSMutableArray alloc] initWithCapacity:0];
//    ChannelObject *channel = [[DeviceControl getInstance] getSelectChannel];
//    if (channel != nil){
...
//    }
    ...
    NSDateComponents* comptEndDate = [calendar components:(NSCalendarUnitYear|NSCalendarUnitMonth|NSCalendarUnitDay|NSCalendarUnitHour|NSCalendarUnitMinute|NSCalendarUnitSecond) fromDate:endDate];
    ...
    endNTime.year = (int)comptEndDate.year;
    endNTime.month = (int)comptEndDate.month;
    endNTime.day = (int)comptEndDate.day;
    endNTime.hour = comptEndDate.hour;
    endNTime.minute = comptEndDate.minute;
    endNTime.second = comptEndDate.second;
...
#pragma mark 搜索云视频文件回调
        case EMSG_MC_SearchMediaByTime:{
            ...
            if ( msg->param1 < 0) {
                ...
                videoArray = [body objectForKey:@"VideoArray"];
