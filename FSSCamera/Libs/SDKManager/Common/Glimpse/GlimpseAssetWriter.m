...
{
    if ([_customizeUrlOutput isEqual:[NSNull null]] || [_customizeUrlOutput isEqualToString:@""]) {
        ...
        NSFileManager *fileManager  = [NSFileManager defaultManager];
        if([fileManager fileExistsAtPath:_customizeUrlOutput]) {
            [fileManager removeItemAtPath:_customizeUrlOutput error:nil];
        }
        return [NSURL fileURLWithPath:_customizeUrlOutput];
    }
}
